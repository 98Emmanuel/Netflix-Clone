...
const fs = require("fs");
const moviesController = require ('./movie');
...
app.get('/list', moviesController.listMovies) // API that shows the list of movies
app.get('/movdet/:id', moviesController.listMoviesById) // API that shows the details of a movie whose ID has been provided

app.get('/show/:id', (req, res) => { //API that plays the movies by Id
    let { id } = req.params;
    ids = id;
